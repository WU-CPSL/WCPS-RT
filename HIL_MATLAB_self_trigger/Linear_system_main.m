...
c=10;
decrease_threshold=increase_threshold/c;
increase_interval=150;
decrease_interval=150;
test_period=50;


global raw_X2OUT raw_X1OUT raw_X3OUT raw_X4OUT raw_X5OUT objective traceout actPDR
raw_X1OUT=[];
raw_X2OUT=[];
raw_X3OUT=[];
raw_X4OUT=[];
...
global jX1 bX1 bP1 jP1 bZ1 Kk1 Buff1 Last1 Buff31 Costfunction1 triggerS1 triggerSS1 triggerT1 triggerTD1 triggertimeI1 triggertimeD1 triggerB1 TRACEAA1 TRACEA_f1 UU_OUT1 uu1 uekf1 xekf1 triggerR triggerR1
jX=Xini;
bX=Xini;
bP=eye(4);
jP=eye(4);
