 ...
 */
#define MINIMUM_LWB_ROUND 			1//1//5

/**
 * Initial network cooloff period, default is 10 seconds
 */
#define COOLOFF_PERIOD				1*IPI//1*IPI

/**
 * Initial network stabilization period, default is 20 seconds
 */
#define STABILIZATION_PERIOD		COOLOFF_PERIOD+1*IPI//COOLOFF_PERIOD+1*IPI
...
// #define GLOSSY_DURATION      	(RTIMER_SECOND / 55)	//18 ms
...
#define DATA_SLOT_LEN	  		(RTIMER_SECOND / 33)    // 18 ms

#define DATA_SLOT_DURATION 		(RTIMER_SECOND / 44)    // 15 ms
...
// #define TX_GUARD_TIME       	(RTIMER_SECOND / 500)	// 2 ms
/**
