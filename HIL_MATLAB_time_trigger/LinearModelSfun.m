function [sys,x0,str,ts,simStateCompliance] = LinearModelSfun(t,x,u,flag,A,B,C,Xini,delta_t,delta_r,delay_s,delay_a,delay_KF,delay_MPC)
...
global Buff3 TRACEAA uu;
Atrace=u(1);
Buff4=[Buff3(1)*ones(1,delta_t/delta_r) Buff3(2)*ones(1,delta_t/delta_r) Buff3(3)*ones(1,delta_t/delta_r) Buff3(4)*ones(1,delta_t/delta_r) Buff3(5)*ones(1,delta_t/delta_r)];
TRACEAA=[TRACEAA Atrace];
